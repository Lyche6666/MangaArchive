...
#[derive(Debug)]
pub struct MangaArchiveProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MangaArchiveProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MangaArchive processing");
    
    let mut processor = MangaArchiveProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MangaArchiveProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MangaArchiveProcessor::new(false);
